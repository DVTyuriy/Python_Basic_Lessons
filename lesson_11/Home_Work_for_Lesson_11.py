COMMAND = [
    ...
    'save -     зберегти ведений текст до нотаток',
...
def open_f() -> list:
    ...
    try:
        ...
        print('Файла з нотатками я не знайшов, давай створимо новий')
...
def name_save_open() -> str:
    return input('Ведіть назву файла: ') + '.txt'
